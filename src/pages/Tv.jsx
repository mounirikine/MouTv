...
const Movies = () => {
  ...
  return (
    <>
      ...
      {selectMovie && (
        <div
          className="relative md:gap-8 lg:gap-1 justify-around mx-3 mb-5 flex flex-col md:flex-row items-center"
          style={{
        ...
        >
          <div className="w-full w-5/12 mx-10- md:w-3/12 lg:w-3/12 mx-auto mb-4 md:mb-0">
            <img
              src={
          ...
          <div
            className="w-full md:w-7/12 text-white text-center md:text-left lg:text-left p-32 me-20"
            style={{
              background: 'rgba(0, 0, 0, 0.5)',
              backdropFilter: 'blur(5px)',
            }}
          >
            <h1 className="text-sm mb-5 underline underline-offset-2">{selectMovie.release_date}</h1>
            <h1 className="text-5xl mb-8">{selectMovie.original_name}</h1>
            <p className="mb-4">
              {selectMovie.overview ? selectMovie.overview : null}
            </p>
            <span>⭐{selectMovie.vote_average} </span> <br />
            <button className="px-10 py-2 mt-1 bg-stone-50 text-black text-semibold rounded-lg flex gap-2 items-center">
      ...
      <div className="w-full flex items-center justify-center mt-32 mb-5">
        <div className="px-4 md:px-8 lg:px-16 xl:px-20">
          ...
          <div>
            <span className="w-12/12 flex items-center justify-center mb-10">
                ...
                >
                  ...
                  <div className="h-[50px] px-2 text-center">
                    <p className="font-medium">
                      {trimTitle(item.original_name || item.name)}
                    </p>
                  </div>
                </div>
              ))}
      ...
      {/* Pagination Section */}
        <div className="px-10">
        <div className="p-3 flex items-center flex-wrap justify-center">
