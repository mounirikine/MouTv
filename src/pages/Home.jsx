...
import { FaCirclePlay, FaFire, FaSearch } from "react-icons/fa";
import "swiper/css";
import "swiper/css/effect-cards";
import { HeroImages } from "../data/HeroImages";
import TrendingMovies from "../components/TrendingMovies";
import Popular from "../components/Populare";
import Uncoming from "../components/Uncoming";
import TopRated from "../components/TopRated";
import HeroSwiper from "../components/HeorSwper";
...
const Home = () => {
  ...
  const fetchMovies = async (searchKey = "") => {
    try {
      ...
      setSelectMovie(response.data.results); // You might want to handle this dynamically based on user interactions
    } catch (error) {
...
<section className="px-4 md:px-8 lg:px-16 xl:px-20">
  <div className="flex items-center justify-center py-5 md:py-8 lg:py-10 px-4 md:px-8 lg:px-14">
    ...
    <span className="w-8/12 flex items-center font-semibold">
      <hr className="w-full md:w-11/12 lg:w-99% mx-auto font-semibold" />
    </span>

    <span className="w-1/12 flex items-center font-semibold px-2">
    <label className='themeSwitcherTwo shadow-card relative inline-flex cursor-pointer select-none items-center justify-center rounded-md bg-white px-1 py-0.5'>
        <input
          type='checkbox'
          className='sr-only'
          checked={isChecked}
        ...
        />
        <span
          className={`flex items-center space-x-[6px] rounded py-0 px-[18px] text-sm font-medium ${
            !isChecked ? 'text-primary bg-[#d61212]' : 'text-black'
          }`}
        >
          {/* <svg
            width='16'
        ...
        <span
          className={`flex items-center space-x-[7px] rounded py-0 px-[18px] text-sm font-medium ${
            isChecked ? 'text-primary bg-[#d61212]' : 'text-black'
          }`}
        >
          {/* <svg
...
<section className="px-4 md:px-8 lg:px-16 xl:px-20">
  <div className="flex items-center justify-center py-5 md:py-8 lg:py-10 px-4 md:px-8 lg:px-14">
    <span className="w-3/12 flex items-center justify-center">
      <FaFire className="text-red-600" />{" "}
      <h1 className="font-bold text-lg md:text-xl">Popular</h1>
    </span>
    <span className="w-8/12 flex items-center font-semibold">
      <hr className="w-full md:w-11/12 lg:w-99% mx-auto font-semibold" />
    </span>
...
<section className="px-4 md:px-8 lg:px-16 xl:px-20">
  <div className="flex items-center justify-center py-5 md:py-8 lg:py-10 px-4 md:px-8 lg:px-14">
    <span className="w-3/12 flex items-center justify-center">
      <FaFire className="text-red-600" />{" "}
      <h1 className="font-bold text-lg md:text-xl">UnComing</h1>
    </span>
    <span className="w-8/12 flex items-center font-semibold">
      <hr className="w-full md:w-11/12 lg:w-99% mx-auto font-semibold" />
    </span>
...
<section className="px-4 md:px-8 lg:px-16 xl:px-20">
  <div className="flex items-center justify-center py-5 md:py-8 lg:py-10 px-4 md:px-8 lg:px-14">
    <span className="w-3/12 flex items-center justify-center">
      <FaFire className="text-red-600 " />{" "}
      <h1 className="font-bold text-lg md:text-xl ">TopRATED</h1>
    </span>
    <span className="w-8/12 flex items-center font-semibold">
      <hr className="w-full md:w-11/12 lg:w-99% mx-auto font-semibold" />
    </span>
